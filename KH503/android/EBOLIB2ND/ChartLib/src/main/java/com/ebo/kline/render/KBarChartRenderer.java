...
public class KBarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public KBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
...
//                mRenderPaint.setColor(dataSet.getColor(j / 4));
                ...
                int i = j / 4;
                if(i >= dataSet.getEntryCount()) break;
                ...
                if (data == null || !(data instanceof HisData)) {
                    ...
                    if (hisData.getClose_price() == 0f && hisData.getOpen_price() == 0f) {
                        if (hisData.getVol() > 0) {
                            mRenderPaint.setColor(dataSet.getColors().get(0));
                        } else {
                            mRenderPaint.setColor(dataSet.getColors().get(1));
            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                if (!dataSet.isStacked()) {
                    ...
                    for (int j = 0; j < buffer.buffer.length * mAnimator.getPhaseX(); j += 4) {
                        ...
                        int k = j / 4;
                        if(k >= dataSet.getEntryCount()) break;
                        BarEntry entry = dataSet.getEntryForIndex(k);
