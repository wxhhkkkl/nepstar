...
/**
 * Created by lvwang2002 on 2019/1/8.
 */
...
public class RNLocationModule extends ReactContextBaseJavaModule{
    ...
    private static String TAG = "RN_LOCATION_MODULE";
     ...
     */
    @ReactMethod
    private void initLocation(Promise promise)  {
//        try{
//            //初始化client
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                if(location.getErrorCode() == 0){
                    ...
                    map.putString("name","DEVICE_GET_LOCATION");
                    map.putDouble("longitude",location.getLongitude());
                    map.putDouble("latitude",location.getLatitude());
                    map.putDouble("accuracy",location.getAccuracy());

                    String address = location.getCountry() + location.getAddress();
