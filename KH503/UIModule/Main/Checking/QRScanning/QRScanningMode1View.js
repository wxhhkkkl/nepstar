...
const Strings = {
    title: '请用微信扫码进行检测',
    titleEN: 'Please use wechat to scan code.',
    subTitle: '检测您的健康状况',
...
const LOG_TAG = '二维码界面';
export default class QRScanningMode1View extends ActionButtonsMixin(PureComponent) {
    constructor(props) {
        super(props)
    ...
    async componentDidMount() { 
        ...
        deviceManager.playSound(SoundId.id_zdd_scan);
