...
import { UserInfo, cloudManager ,AppointmentCodeUserInfo} from '../../../../Cloud/CloudManager';
/** 模式10 */
...
export default class VerifyCodeInputM10View extends ActionButtonsMixin(PureComponent) {
    constructor(props){
        super(props)

        if(AppointmentCodeUserInfo && AppointmentCodeUserInfo.detail){
            const {age,height,weight,userName,salesmanCode,mobile} = AppointmentCodeUserInfo.detail
            this.state = {
                age:age,
                height:height,
                weight:weight,
                ...
                <View style={{
                    ...
                    <View>
                        ...
                        {/* <Text style={{
                            ...
                            marginLeft:PublicMethods.designToPixel(240),
                            fontSize:PublicMethods.designToPixel(24),
                            color:'red',
                        }}>{'*请使用预约时输入的手机号'}</Text> */}
