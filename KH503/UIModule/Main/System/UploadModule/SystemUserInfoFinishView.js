...
const Strings = {
    ...
    title: '检测已完成\n请用手机扫描二维码查看健康评估报告',
    titleEN: 'The test has been completed, please scan the qr code with your mobile phone to check the health report',
    desc: '感谢使用,祝您健康！',
...
export default class SystemUserInfoFinishView extends ActionButtonsMixin(PureComponent) {
    constructor(props) {
        super(props)
        this.overTimer = null;
    ...
    componentDidMount() {
        ...
        if (global.isPrint) {
            ...
            // 公众号查看报告版本
            deviceManager.playSound(SoundId.id_user_info_report_finish)
        }
