...
const Strings = {
    title: '检测已完成\n请在小程序查看您的健康评估报告',
    titleEN: 'The test has been completed.Please use mini programs to check your health report.',
    desc: '感谢使用,祝您健康！',
...
export default class SystemMode8FinishView extends ActionButtonsMixin(PureComponent) {
    constructor(props) {
        super(props)
        this.overTimer = null;
    ...
    componentDidMount() {
        ...
        deviceManager.playSound(SoundId.id_miniprogram_finish)
