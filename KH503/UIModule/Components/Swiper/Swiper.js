 ...
 */
 ...
 export default class Swiper extends Component {
   ...
   onScrollBegin = e => {
     // update scroll state
     console.log('Swiper:','on scroll begin')
   ...
   onScrollEnd = e => {
     ...
     console.log('Swiper on scroll end:',e.nativeEvent.contentOffset)
    ...
    */
   onScrollEndDrag = e => {
    console.log('Swiper on scroll drag end:',e.nativeEvent.contentOffset)
  ...
  scrollTo = (offset, animated = true) => {
    this.scrollView && this.scrollView.scrollTo({ x:offset,y:0, animated })
  }
   ...
   render() {
     ...
     const pageStyle = [{ width: 200, height: height }, styles.slide]
