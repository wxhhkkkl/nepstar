...
const { Shape, Path,LinearGradient,RadialGradient} = ART;
...
export default class Wedge extends Component {
    ...
    _createLinearGradient = (originX, originY, startAngle, endAngle, or, ir)=>{
    ...
    render()  {
        ...
        const gradient = this._createLinearGradient(originX, originY, startAngle, endAngle, or, ir)

        return <Shape {...this.props} d={path} fill={gradient} />;
    }
}
