...
<style scoped>
.login-page { display: flex; justify-content: center; align-items: center; min-height: 100vh; padding: 24px; background: radial-gradient(circle at 15% 15%, #123f42 0, transparent 28%), radial-gradient(circle at 85% 80%, #14474a 0, transparent 26%), #0e2f31; position: relative; overflow: hidden; }
...
.blob-1 { width: 400px; height: 400px; background: #17b3b7; top: -100px; left: -80px; animation-delay: 0s; }
.blob-2 { width: 300px; height: 300px; background: #2bb9bc; bottom: -80px; right: -60px; animation-delay: -4s; }
.blob-3 { width: 200px; height: 200px; background: #029ba0; top: 40%; left: 60%; animation-delay: -7s; }
.blob-4 { width: 250px; height: 250px; background: #76d4d7; bottom: 20%; left: -100px; animation-delay: -10s; }
@keyframes float {
