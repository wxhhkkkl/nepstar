...
**Tests**: Tests are REQUIRED by the project constitution (Principle I: TDD — see `.specify/memory/constitution.md`). Tests MUST be written first and confirmed to FAIL before implementation.
